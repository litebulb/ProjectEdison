        ...
        public ResponseStateMachine(IOptions<ServiceBusRabbitMQOptions> configBus, IOptions<WorkflowConfig> configWorkflow)
        {
            ...
            Initially(
                When(NewResponseCreated)
                    ...
                    //Run open actions
                     .ThenAsync(context => context.Data.ResponseModel.ActionPlan.OpenActions.Where(p => !p.RequiresLocation) // || (context.Data.ResponseModel.Geolocation != null && p.RequiresLocation) //Not running location actions
