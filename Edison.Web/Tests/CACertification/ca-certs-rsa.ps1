...
New-Item -ItemType directory -Path "./EdisonRSA"
$rootCACerFileName          = "./EdisonRSA/RootCA.cer"
$rootCAPemFileName          = "./EdisonRSA/RootCA.pem"
$rootCAPfxFileName          = "./EdisonRSA/RootCA.pfx"
$intermediate1CAPemFileName = "./EdisonRSA/Intermediate_ButtonSensor.pem"
